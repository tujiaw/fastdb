...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_GlobalSignal_t, stringdata) + ofs \
...
void GlobalSignal::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->sigFastdbLog((*reinterpret_cast< const QString(*)>(_a[1]))); break;
        default: ;
        }
        ...
        {
            typedef void (GlobalSignal::*_t)(const QString & );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&GlobalSignal::sigFastdbLog)) {
                *result = 0;
            }
        }
    }
...
const QMetaObject GlobalSignal::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_GlobalSignal.data,
      qt_meta_data_GlobalSignal,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_GlobalSignal.stringdata))
        return static_cast<void*>(const_cast< GlobalSignal*>(this));
...
// SIGNAL 0
void GlobalSignal::sigFastdbLog(const QString & _t1)
{
